...
class AppColors {
  ...
  static final Color lightGrey = Color(0xFFF5F5FA);
  ...
  static final Color levelButtonMedio = Color(0xFFE1F5EC);
  static final Color levelButtonDificil = Color(0xFFF5EFE9);
  static final Color levelButtonPerito = Color(0xFFF5E9EC);
  ...
  static final Color levelButtonTextMedio = Color(0xFF03AB4F);
  static final Color levelButtonTextDificil = Color(0xFFE8891C);
  static final Color levelButtonTextPerito = Color(0xFFCC3750);
}
